...
export const piecesRender = {
  ...
  addPiecesBoxListeners() {
    $$(chessConfig.chessPieceBoxSelector).forEach((pieceBoxElement) => {
      ...
      pieceBoxElement.addEventListener(
        "mouseenter",
        this.piecesEventListeners[pieceBoxPosition]["mouseenter"]
      );
      pieceBoxElement.addEventListener(
        "mouseleave",
        this.piecesEventListeners[pieceBoxPosition]["mouseleave"]
      );
      pieceBoxElement.addEventListener(
        "click",
        this.piecesEventListeners[pieceBoxPosition]["click"]
      );
    });
  },
  resetPiecesBoxListeners() {
    $$(chessConfig.chessPieceBoxSelector).forEach((pieceBoxElement) => {
      ...
      pieceBoxElement.removeEventListener(
        "mouseenter",
        this.piecesEventListeners[pieceBoxPosition]["mouseenter"]
      );
      pieceBoxElement.removeEventListener(
